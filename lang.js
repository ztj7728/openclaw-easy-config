const translations = {
  zh: {
    ...
    label_memorysearch_enable: "启用 memorySearch 向量记忆检索",
    label_memorysearch_provider: "MemorySearch Provider",
    label_memorysearch_model: "Embedding Model",
    label_memorysearch_use_chat_remote: "复用主聊天配置的 Base URL 与 API Key",
    label_memorysearch_remote_baseurl: "MemorySearch Base URL",
    label_memorysearch_remote_provider: "MemorySearch 远端提供商（快捷选择）",
    label_memorysearch_apikey: "MemorySearch API Key",
    label_config: "Config (JSON/JSON5/String)",
    config_hint: "支持 JSON5 语法，例如注释、尾随逗号和单引号字符串。",
    memorysearch_hint: "默认关闭。开启后可配置向量检索模型与远端嵌入服务。",
    memorysearch_remote_hint: "勾选后会直接使用上方聊天模型配置里的 Base URL 与 API Key。",
    ...
    placeholder_memorysearch_provider: "输入自定义 memorySearch provider",
    placeholder_memorysearch_model: "输入自定义 embedding model",
    placeholder_memorysearch_remote_baseurl: "输入自定义 memorySearch Base URL",
    placeholder_memorysearch_remote_provider: "输入自定义远端提供商",
    placeholder_memorysearch_apikey: "请输入 memorySearch API Key",
    ...
    err_no_memorysearch_provider: "错误: 请输入 memorySearch provider",
    err_no_memorysearch_model: "错误: 请输入 memorySearch model",
    err_no_memorysearch_baseurl: "错误: 请选择或输入 memorySearch Base URL",
    err_no_memorysearch_apikey: "错误: 请输入 memorySearch API Key",
  ...
  en: {
    ...
    label_apikey: "API Key",
    label_memorysearch_enable: "Enable memorySearch vector retrieval",
    label_memorysearch_provider: "MemorySearch Provider",
    label_memorysearch_model: "Embedding Model",
    label_memorysearch_use_chat_remote: "Reuse chat Base URL and API Key",
    label_memorysearch_remote_baseurl: "MemorySearch Base URL",
    label_memorysearch_remote_provider: "MemorySearch Remote Provider (Quick Select)",
    label_memorysearch_apikey: "MemorySearch API Key",
    label_config: "Config (JSON/JSON5/String)",
    config_hint: "Supports JSON5 syntax such as comments, trailing commas, and single-quoted strings.",
    memorysearch_hint: "Disabled by default. Enable it to configure the embedding model and remote embedding service.",
    memorysearch_remote_hint: "When checked, the chat Base URL and API Key above are reused directly.",
    ...
    placeholder_memorysearch_provider: "Enter custom memorySearch provider",
    placeholder_memorysearch_model: "Enter custom embedding model",
    placeholder_memorysearch_remote_baseurl: "Enter custom memorySearch Base URL",
    placeholder_memorysearch_remote_provider: "Enter custom remote provider",
    placeholder_memorysearch_apikey: "Enter the memorySearch API key",
    ...
    err_no_memorysearch_provider: "Error: Please enter a memorySearch provider",
    err_no_memorysearch_model: "Error: Please enter a memorySearch model",
    err_no_memorysearch_baseurl: "Error: Please select or enter a memorySearch Base URL",
    err_no_memorysearch_apikey: "Error: Please enter a memorySearch API Key",
